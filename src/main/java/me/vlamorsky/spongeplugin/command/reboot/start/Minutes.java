...
public class Minutes implements CommandExecutor {
    @Override
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (reasonOP.isPresent()) {
            TimeCheckerThread.setRestartDateTime(LocalDateTime.now().plusMinutes(timeAmount), reasonOP.get());
        } else {
            TimeCheckerThread.setRestartDateTime(LocalDateTime.now().plusMinutes(timeAmount));
        }
